...
export const MobileTableOfContents: React.FC<MobileTableOfContentProps> = ({
    groupBySection,
    setPage,
    open,
    setIsOpen,
    ...
    return (
        <>
            {open ? (
                ...
                >
                    <div className=" relative w-auto pointer-events-none h-full flex">
                        <div className=" border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current z-50 ">
                            ...
                            <div className=" relative p-4  overflow-auto flex-1">
